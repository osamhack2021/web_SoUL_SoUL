	...
	<div>
		...
		<div id="main-contaniner">
			...
			<section id="writing-box">
				...
				<textarea id="maintext-box" v-model="textValue" cols="85" rows="25" autofocus placeholder="본문" />
...
<style scoped>	
	...
	#main-contaniner #writing-box-header .button-default {
		width: 100px;
		height: 40px;
